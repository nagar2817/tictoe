...
ALLOWED_HOSTS = [".replit.dev", ".replit.app","https://tictoe-vcin.onrender.com"]
CSRF_TRUSTED_ORIGINS = ["https://*.replit.dev", "https://*.replit.app", "https://tictoe-vcin.onrender.com"]
